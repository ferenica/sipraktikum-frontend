 ...
 * @param {*} props
 */
export default function ListSubmisiAkhirKoor(props) {
  ...
  return (
    <>
      {/* <Wrapper> */}
      <StyledButton href={`/koordinator-kuliah/penilaian-laporan-akhir/detail/${props.mahasiswa.user.username}/${props.laporan.id}`}>
        <Col sm="1">
