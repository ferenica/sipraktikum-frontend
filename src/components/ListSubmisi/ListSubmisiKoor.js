 ...
 * @param {*} props
 */
export default function ListSubmisiKoor(props) {
  ...
  console.log('nyampe list submisi koor');
  return (
    <>
      <StyledButton href={`/koordinator-kuliah/penilaian/detail/${props.mahasiswa.user.username}/${props.laporan.id}`}>
