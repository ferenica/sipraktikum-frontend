...
import DetailSubmisiLaporanAkhirData from './../../../components/MKPPL/DetailSubmisiData/DetailSubmisiLaporanAkhirData';
import DetailSubmisiLaporanAkhirDataKoor from './../../../components/MKPPL/DetailSubmisiData/DetailSubmisiLaporanAkhirDataKoor';
...
/** */
export default class DetailSubmisiLaporanAkhir extends Component {
    state = {
      error: null,
      isLoaded: false,
      daftarLaporan: null,
        ...
        return (
          <>
            ...
            {this.props.action === 'koordinator-kuliah' ?
              <DetailSubmisiLaporanAkhirDataKoor content={daftarLaporan} user={userInfo} mahasiswa={mahasiswaInfo} path={window.location.pathname}/>
              : <DetailSubmisiLaporanAkhirData content={daftarLaporan} user={userInfo} mahasiswa={mahasiswaInfo} path={window.location.pathname}/>
            }
          </>
        );
      }
